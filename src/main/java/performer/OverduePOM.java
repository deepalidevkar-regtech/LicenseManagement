...
public class OverduePOM extends webpage
{
	...
	public static WebElement AppliedSubmit()		//Method for searching button for Submit Form
	{
		submit = getDriver().findElement(By.xpath("//input[@value ='Submit']"));
		//*[@id="btnSubmit"]
		return submit;
	...
	{
		dashboard = getDriver().findElement(By.xpath("//*[@id='btnSubmit']"));
		return dashboard;
	}
	...
	public static WebElement ActiveAction()		//Method to search Dropdown.
	{
		msgElement = getDriver().findElement(By.xpath("(//*[@class='k-button k-button-icontext ob-overview k-grid-overview'])[1]"));
		return msgElement;
	}
	public static WebElement ExpiringAction()		//Method to search Dropdown.
	{
		dropdown = getDriver().findElement(By.xpath("(//*[@class='k-button k-button-icontext ob-overview k-grid-overview'])[1]"));
		return dropdown;
	}
	public static WebElement RejectedAction()		//Method to search Dropdown.
	{
		dropdown = getDriver().findElement(By.xpath("(//*[@class='k-button k-button-icontext ob-overview k-grid-overview'])[1]"));
		return dropdown;
	}
	...
	{
		performer = getDriver().findElement(By.xpath("//*[@id='grid']/div[3]/span[2]"));
		return performer;
	}
	...
	{
		performer = getDriver().findElement(By.xpath("(//*[@id='DocumentShareListNew']/a)[2]"));
		return performer;
	}
	...
	public static WebElement clickPeople1()				//Searching People input box 
	{
		performer = getDriver().findElement(By.xpath("(//*[@class='multiselect dropdown-toggle btn btn-default'])[2]"));
		return performer;
	}
	...
	public static WebElement clickSearchPeople1()		//Searching 'Search People' input box
	{
		performer = getDriver().findElement(By.xpath("(//*[@class='form-control multiselect-search'])[2]"));
		return performer;
	}
	...
	public static WebElement clickPeopleCheckBox()		//Clicking on Checkbox in front of name
	{
		...
		performer = getDriver().findElement(By.xpath("(//*[@class='checkbox'])[65]"));
		return performer;
	
	}
	public static WebElement clickfileCheckBox()		//Clicking on Checkbox in front of name
	{
		//performer = getDriver().findElement(By.xpath("//*[@id='divOpenPermissionPopup']/div/div/div[2]/div[3]/div/span/div/ul/li[143]/a/label/input"));
		performer = getDriver().findElement(By.xpath("(//*[@class='checkbox'])[4]"));
		return performer;
	...
	public static WebElement PerformerDoc()			//Searching upload New File button
	{
		performer = getDriver().findElement(By.xpath("//*[@id='fuSampleFile']"));
		return performer;
	}
	...
	public static void MyReminder(ExtentTest test, String compliance) throws InterruptedException
	{
		...
		wait.until(ExpectedConditions.elementToBeClickable(CFOcountPOM.readTotalItems1()));
		...
		for(int i = 0; i <= 1; i++)
		{
			if(remindersCount.equalsIgnoreCase("to"))
			{
				...
				{			//Waiting till the grid's second row's fifth column data gets clickable.
					wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@class = 'k-grid-content k-auto-scrollable']/table/tbody/tr[2]/td[5]")));
				}
				catch(Exception e)
				{
		...
		Thread.sleep(500);
		wait.until(ExpectedConditions.visibilityOf(clickComplianceType()));
		wait.until(ExpectedConditions.elementToBeClickable(clickComplianceType()));
		clickComplianceType().click();
		Thread.sleep(500);
		if(compliance.equalsIgnoreCase("Internal"))
...
WebDriverWait wait = new WebDriverWait( getDriver(), (30));
		...
		uploadNewFile().sendKeys(workingDir+"//Reports//PerformerResults.html");	//uploading new file		
		...
		Thread.sleep(500);
		clickSearchPeople().sendKeys("amol");			//Writing user name to search for
		
		Thread.sleep(500);
		clickPeopleCheckBox().click();				//Clicking on label to get out from people search box
	...
	public static void ReviseCompliance(ExtentTest test, int no) throws InterruptedException
	{
		...
		if(no == 2)
		{
			...
			Thread.sleep(500);
			ComplianceDocumentLink().sendKeys("www.google.com");
			
			Thread.sleep(500);
			String workingDir = System.getProperty("user.dir");			
			upload1().sendKeys(workingDir+"//Reports//PerformerResults.html");	//uploading new file
		}

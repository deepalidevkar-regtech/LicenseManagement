	...
	public class AuditorInternalTC extends webpage{
		...
		{
			String workingDir = System.getProperty("user.dir");
			extent = new com.relevantcodes.extentreports.ExtentReports(workingDir+"//Reports//new//LicenseAuditorResult(Internal).html",true);
			test = extent.startTest("Logging In - Auditor(Internal)");
	  ...
	  void BystatusActiveInternalgraph() throws InterruptedException
		{
		 ...
		 @Test(priority = 13)
		  ...
		  void BystatusExpiredInternal() throws InterruptedException
			...
			@Test(priority = 15)
		  void Bystatusappliedgraph() throws InterruptedException
			{
	...
	/*@Test(priority = 26)
		void MyWorkspace() throws InterruptedException, IOException
		{
		   ...
		   //	drp.selectByIndex(1);
			...
			//test.log(LogStatus.INFO, "Test Initiated");
	      DeptHeadMethod.DeptMyworkspaceaddLicense( test, "Internal");

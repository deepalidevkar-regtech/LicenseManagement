...
//	@Test(priority = 3)
	void ActiveInternalLicense() throws InterruptedException
	{
		...
		licenseCompanyadmin.StatutoryMethod.ActiveInternalLicense(driver, test, "Internal");
 ...
 // @Test(priority = 4)
		void ExpiringInternalLicense() throws InterruptedException
		{
		    ...
		    licenseManagement.licmgmtMethodPOM.ExpiringInternalLicense(driver, test, "Internal");
 ...
 // @Test(priority = 5)
	void ExpiredInternalLicense() throws InterruptedException
	{
		...
		licenseCompanyadmin.StatutoryMethod.ExpiredInternalLicense(driver, test, "Internal");
